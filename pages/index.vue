<template>
  <div>
    <ShellFrame title="Lifestyle" :data="SHOES" />
  </div>
</template>
...
const SHOES = ref([
  {
    ...
    imageSrc: "/img/tech-challenge.jpg",
    price: 16500,
    salePrice: null,
    // 1 hour ago! 🔥
  ...
  },
  {
    ...
    imageSrc: "/img/legend-academy.jpg",
    price: 16500,
    salePrice: 12500,
  ...
  },
  {
    ...
    imageSrc: "/img/react-infinity.jpg",
    price: 16000,
    salePrice: 14500,
  ...
  },
  {
    ...
    imageSrc: "/img/phantom-flyknit.jpg",
    price: 18500,
    salePrice: 16000,
